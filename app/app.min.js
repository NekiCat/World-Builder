...
var WorldBuilder
!function(e){var r=function(){function e(e,r,t){this.$scope=e,this.$scope.$storage=r.$default({projects:[]}),this.$scope.project=this.$scope.$storage.projects.filter(function(e){return e.guid===t.project})[0]}return e.$inject=["$scope","$localStorage","$routeParams"],e}()
e.TermListController=r,angular.module("WorldBuilder").config(["$routeProvider",function(e){e.when("/projects/:project/terms",{templateUrl:"views/termList/termList.html",controller:"TermListController"})}]).controller("TermListController",r)}(WorldBuilder||(WorldBuilder={}))
