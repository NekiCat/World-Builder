...
var n,i,c=Math.max(o,r,t),l=Math.min(o,r,t),s=(c+l)/2
if(c===l)n=i=0
else{var a=c-l
switch(i=s>.5?a/(2-c-l):a/(c+l),c){case o:n=(r-t)/a+(r<t?6:0)
break
case r:n=(t-o)/a+2
break
case t:n=(o-r)/a+4}n/=6}return[n,i,s]}function t(e,r,t){void 0===r&&(r=0),void 0===t&&(t=0)
var o
Array.isArray(e)?(o=e[0],r=e[1],t=e[2]):o=e
var n,i,c
if(0===r)n=i=c=0
else{var l=function(e,r,t){return t<0&&(t+=1),t>1&&(t-=1),t<1/6?e+6*(r-e)*t:t<.5?r:t<2/3?e+(r-e)*(2/3-t)*6:e},s=t<.5?t*(1+r):t+r-t*r,a=2*t-s
n=l(a,s,o+1/3),i=l(a,s,o),c=l(a,s,o-1/3)}return[255*n,255*i,255*c]}e.rgbToHsl=r,e.hslToRgb=t}(r=e.Util||(e.Util={}))}(WorldBuilder||(WorldBuilder={}))
var WorldBuilder
!function(e){var r
