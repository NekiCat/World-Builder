...
this.$scope=r,this.$scope.$storage=t.$default({projects:[]}),this.$scope.project=this.$scope.$storage.projects.filter(function(e){return e.guid===o.project})[0],this.$scope.project||i.path("/projects"),this.$scope.createItem=function(){return e.Util.insertNameable(c.$scope.project.characters,e.Character)},this.$scope.removeItem=function(r){return e.Util.removeStart(c.$scope.project.characters,r)},this.$scope.removeUndo=function(r){return e.Util.removeUndo(c.$scope.project.characters,r)},this.$scope.$on("$locationChangeSuccess",function(o){e.Util.removeEnd(r.project.characters),t.$apply()})}return r.$inject=["$scope","$localStorage","$routeParams","$location","$timeout"],r}()
