...
var WorldBuilder
!function(e){var r
!function(e){function r(e,r){for(var t=new r,o=0,i=t.name;e.filter(function(e){return e.name.toLowerCase()==i.toLowerCase()}).length>0;)i=t.name+" ("+ ++o+")"
t.name=i,e.push(t)}function t(e,r){e.indexOf(r)>-1&&(r.deleted=!0)}function o(e){for(var r=e.length;r--;)e[r].deleted&&e.splice(r,1)}function i(e,r){r.deleted=!1}e.createNameable=r,e.removeStart=t,e.removeEnd=o,e.removeUndo=i}(r=e.Util||(e.Util={}))}(WorldBuilder||(WorldBuilder={}))
var WorldBuilder
!function(e){var r=function(){function r(r,t,o,i,n){var c=this
this.$scope=r,this.$scope.$storage=t.$default({projects:[]}),this.$scope.project=this.$scope.$storage.projects.filter(function(e){return e.guid===o.project})[0],this.$scope.project||i.path("/projects"),this.$scope.createItem=function(){return e.Util.createNameable(c.$scope.project.characters,e.Character)},this.$scope.removeItem=function(r){return e.Util.removeStart(c.$scope.project.characters,r)},this.$scope.removeUndo=function(r){return e.Util.removeUndo(c.$scope.project.characters,r)},this.$scope.$on("$locationChangeSuccess",function(){e.Util.removeEnd(r.project.characters),t.$apply()})}return r.$inject=["$scope","$localStorage","$routeParams","$location","$timeout"],r}()
