...
o>-1&&confirm(t.replace("{0}",r.name))&&e.splice(o,1)}function i(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){var r=16*Math.random()|0,t="x"==e?r:3&r|8
...
var WorldBuilder
!function(e){var r
!function(e){function r(e,r){e.indexOf(r)>-1&&(r.deleted=!0)}function t(e){for(var r=e.length;r--;)e[r].deleted&&e.splice(r,1)}function o(e,r){r.deleted&&(r.deleted=!1)}e.removeStart=r,e.removeEnd=t,e.removeUndo=o}(r=e.Util||(e.Util={}))}(WorldBuilder||(WorldBuilder={}))
var WorldBuilder
!function(e){var r=function(){function r(r,t,o,i,n){var c=this
this.$scope=r,this.$scope.$storage=t.$default({projects:[]}),this.$scope.project=this.$scope.$storage.projects.filter(function(e){return e.guid===o.project})[0],this.$scope.project||i.path("/projects"),this.$scope.createCharacter=function(){return e.Util.insertNameable(c.$scope.project.characters,e.Character)},this.$scope.deleteCharacter=function(r){return e.Util.removeStart(c.$scope.project.characters,r)},this.$scope.deleteCharacterUndo=function(r){return e.Util.removeUndo(c.$scope.project.characters,r)},this.$scope.$on("$locationChangeSuccess",function(o){e.Util.removeEnd(r.project.characters),t.$apply()})}return r.$inject=["$scope","$localStorage","$routeParams","$location","$timeout"],r}()
