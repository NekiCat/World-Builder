...
/// <reference path="../../../typings/index.d.ts"/>
var WorldBuilder
!function(r){function e(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(r){var e=16*Math.random()|0,t="x"==r?e:3&e|8
return t.toString(16)})}r.createGUID=e,angular.module("WorldBuilder",["ngRoute","ngStorage"]).config(["$locationProvider","$routeProvider",function(r,e){r.hashPrefix("!"),e.otherwise({redirectTo:"/projects"})}]).filter("escape",["$window",function(r){return r.encodeURIComponent}])}(WorldBuilder||(WorldBuilder={}))
var WorldBuilder
!function(r){var e=function(){function e(){this.guid=r.createGUID(),this.name="New Character"}return e}()
r.Character=e}(WorldBuilder||(WorldBuilder={}))
var WorldBuilder
!function(r){var e=function(){function e(){this.guid=r.createGUID(),this.name="New Event"}return e}()
r.Event=e}(WorldBuilder||(WorldBuilder={}))
var WorldBuilder
!function(r){var e=function(){function e(){this.guid=r.createGUID(),this.name="New Location"}return e}()
r.Location=e}(WorldBuilder||(WorldBuilder={}))
var WorldBuilder
!function(r){var e=function(){function r(){}return r}()
r.Icon=e
var t=function(){function e(){this.guid=r.createGUID(),this.name="New Project",this.characters=[],this.locations=[],this.events=[],this.terms=[]}return e}()
r.Project=t}(WorldBuilder||(WorldBuilder={}))
var WorldBuilder
!function(r){var e=function(){function e(){this.guid=r.createGUID(),this.name="New Term"}return e}()
...
var WorldBuilder
!function(r){var e=function(){function r(r,e,t){this.$scope=r,this.$scope.$storage=e.$default({projects:[]}),this.$scope.project=this.$scope.$storage.projects.filter(function(r){return r.guid===t.project})[0],this.$scope.getRng=this.getRng}return r.prototype.getRng=function(){return 50*Math.random()*175},r.$inject=["$scope","$localStorage","$routeParams"],r}()
...
e.name+=" ("+t.toString()+")"}this.$scope.$storage.projects.push(e)},e.prototype.deleteProject=function(r){var e=this.$scope.$storage.projects.indexOf(r)
e>=0&&confirm("Do you really want to delete the whole project '"+this.$scope.$storage.projects[e].name+"'? This cannot be undone!")&&this.$scope.$storage.projects.splice(e,1)},e.$inject=["$scope","$localStorage"],e}()
